...
from sqlalchemy import Boolean, CheckConstraint, DateTime, ForeignKey, String, Integer, func
...
class Recipe(Base):
    ...
    tools_needed: Mapped[list[str]] = mapped_column(ARRAY(String), nullable=True)
