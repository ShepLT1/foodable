...
-- 3. Recipes matching existing migration columns (_json suffix)
...
values
  ('aaaaaaaa-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111',
    ...
    '[{"name":"broccoli","quantity":1,"unit":"head"},{"name":"soy sauce","quantity":2,"unit":"tbsp"},{"name":"tofu","quantity":200,"unit":"g"}]'::jsonb,
    '["Chop veggies","Stir fry 8 min","Add sauce"]'::jsonb,
    '{"calories":420,"protein_g":18,"carbs_g":45,"fat_g":14}'::jsonb,
    'asian', 'dinner', true),

  ('aaaaaaaa-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111',
    'Chicken & Chickpea Curry', 'A hearty, spiced curry with tender chicken and chickpeas simmered in coconut milk.',
    '[{"name":"chicken thighs","quantity":1.5,"unit":"lb"},{"name":"chickpeas","quantity":1,"unit":"can"},{"name":"coconut milk","quantity":1,"unit":"can"}]'::jsonb,
    '["Dice chicken","Simmer curry ingredients for 25 min","Serve with rice"]'::jsonb,
    '{"calories":650,"protein_g":42,"carbs_g":55,"fat_g":28}'::jsonb,
    'indian', 'dinner', true),
  ...
  ('aaaaaaaa-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111',
    ...
    '[{"name":"salmon fillet","quantity":2,"unit":"pieces"},{"name":"asparagus","quantity":1,"unit":"bunch"},{"name":"lemon","quantity":1,"unit":"whole"}]'::jsonb,
    '["Season salmon and asparagus","Bake at 400F for 15 minutes"]'::jsonb,
    '{"calories":510,"protein_g":38,"carbs_g":12,"fat_g":32}'::jsonb,
    'american', 'dinner', true),
  ...
  ('aaaaaaaa-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111',
    ...
    '[{"name":"ground turkey","quantity":1,"unit":"lb"},{"name":"taco shells","quantity":6,"unit":"whole"},{"name":"salsa","quantity":0.5,"unit":"cup"}]'::jsonb,
    '["Brown turkey in pan","Add seasoning","Assemble in taco shells"]'::jsonb,
    '{"calories":480,"protein_g":34,"carbs_g":38,"fat_g":18}'::jsonb,
    'mexican', 'dinner', true),
  ...
  ('aaaaaaaa-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111111',
    ...
    '[{"name":"quinoa","quantity":1,"unit":"cup"},{"name":"cucumber","quantity":1,"unit":"whole"},{"name":"feta cheese","quantity":50,"unit":"g"}]'::jsonb,
    '["Cook quinoa","Chop veggies","Toss with olive oil and feta"]'::jsonb,
    '{"calories":390,"protein_g":14,"carbs_g":52,"fat_g":16}'::jsonb,
    'mediterranean', 'lunch', true),
  ...
  ('aaaaaaaa-0000-0000-0000-000000000006', '11111111-1111-1111-1111-111111111111',
    ...
    '[{"name":"whole grain bread","quantity":2,"unit":"slices"},{"name":"avocado","quantity":1,"unit":"whole"},{"name":"eggs","quantity":2,"unit":"whole"}]'::jsonb,
    '["Toast bread","Poach eggs","Mash avocado and assemble"]'::jsonb,
    '{"calories":430,"protein_g":19,"carbs_g":30,"fat_g":24}'::jsonb,
    'american', 'breakfast', true);
